    ...
    methods: {
        ...
        generateShortcode() {
            ...
            if (img == undefined || null) {
                ...
                shortcode = `{ type: '${this.jumbotronType}', url: '${this.videoResult}', title-position : '${this.titlePos}', color: '${this.titleColor}' }`;
            }
            // type image
            else if(vid == undefined || null) {
                this.videoResult = ''
                shortcode = `{ type: '${this.jumbotronType}', url: '${this.backgroundResult}', title-position : '${this.titlePos}', color: '${this.titleColor}' }`;
            } else {
                shortcode = `{}`
            }
